...
<body class="homepage">
  ...
  <!-- new arrivals and categories -->
  @include('components.newarrivals')

  <!-- bestseller section -->
  @include('components.bestseller')

  <!-- related vdo products section -->
  @include('components.vdo')

  <!--blog & product section -->
  @include('components.blogproduct')
  ...
  <script src="{{ asset("customJs/jquery.min.js") }}"></script>
  <script src="{{ asset("customJs/modernizr.js") }}"></script>
  <script src="{{ asset("customJs/plugins.js") }}"></script>
  <script src="{{ asset("customJs/script.min.js") }}"></script>
  <script src="{{ asset("customJs/SmoothScroll.js") }}"></script>
</body>
